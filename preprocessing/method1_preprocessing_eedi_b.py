...
q_t = pd.read_csv("./data/eedi_b/train_task_3_4.csv")
q_t['ind'] = q_t.index
...
# Make question_info 
question_info = pd.read_csv('./data/eedi_b/question_metadata_task_3_4.csv')
...
# time merge
answer_info = pd.read_csv('./data/eedi_b/answer_metadata_task_3_4.csv')
...
result_df.to_pickle("../data/eedi_b/method_1/eedi_b.pkl")